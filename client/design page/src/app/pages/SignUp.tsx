          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-[#9CA3AF]" style={{ fontFamily: 'var(--font-sans)' }}>
                  or
                </span>
              </div>
            </div>
            ...
            {/* Terms */}
            <p className="text-center text-[#9CA3AF] text-[11px] mt-4" style={{ fontFamily: 'var(--font-sans)' }}>
